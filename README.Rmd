...
Sys.setenv(GENIUS_API_TOKEN = 'j06gNlTF2KKmNyQjKW6gFrZe86dwUIKoML_ypqRNNRzyJl1fmZn75kawEUUhUVJW')
```
...
You can install the development version of `rgenius` from [Github](https://github.com/AlbertoAlmuinha/rgenius) with:
